...
class Project(info: ProjectInfo) extends DefaultWebProject(info) with SiteGenWebProject {
  ...
  lazy val scalate_core     = "org.fusesource.scalate" % "scalate-core"     % "1.6.1" 
  lazy val scalate_wikitext = "org.fusesource.scalate" % "scalate-wikitext" % "1.6.1" 
  lazy val scalate_page     = "org.fusesource.scalate" % "scalate-page"     % "1.6.1" 
  lazy val scalamd          = "org.fusesource.scalamd" % "scalamd"          % "1.6" 
